...
namespace MateEngine.Platform.Windows
{
    ...
    public class WindowsScreenService : IScreenService
    {
        ...
        {
#if UNITY_STANDALONE_WIN
            int left = GetSystemMetricsWin32(SM_XVIRTUALSCREEN);
            int top = GetSystemMetricsWin32(SM_YVIRTUALSCREEN);
            int width = GetSystemMetricsWin32(SM_CXVIRTUALSCREEN);
            int height = GetSystemMetricsWin32(SM_CYVIRTUALSCREEN);
        ...
        {
#if UNITY_STANDALONE_WIN
            return GetSystemMetricsWin32(index);
#else
            return 0;
#endif
        }
        ...
        private static extern int GetSystemMetricsWin32(int nIndex);
#endif
    }
}
